...
class TestProfileSensitiveDataProtection:
    ...
    def test_profile_response_never_contains_cpf(
    ...
    def test_profile_response_never_contains_rg(
        self, client: TestClient, auth_headers: dict, seeded_db
    ):
    ...
    def test_profile_response_indicates_has_documents(
        self, client: TestClient, auth_headers: dict, seeded_db
    ):
