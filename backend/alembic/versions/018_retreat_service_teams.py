...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["registration_id"], ["retreat_registrations.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("registration_id", "preference_order",
                            name="uq_team_preference_reg_order"),
    )
